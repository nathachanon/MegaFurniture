...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdn.jsdelivr.net/npm/sweetalert2@7.33.1/dist/sweetalert2.min.css">
                    ...
                    <div class="row">
                        <div class="col d-flex flex-row">
                            ...
                            <div class="top_bar_contact_item">
                                <div class="top_bar_icon"><img style="width: 20px; filter: opacity(0.5);"
                                        src="../layout/images/store-solid.svg" alt=""></div><a
                                    href="/login">ขายสินค้า</a>
                            </div>
                            <div class="top_bar_content ml-auto">

                                <div class="top_bar_user" id="top_bar_user">
                                    <div class="user_icon"><img style="width: 20px; height: 20px; filter: opacity(0.5);"
                                            src="../layout/images/user-solid.svg" alt=""></div>
                                    <div><a data-toggle="modal" data-target="#modalRegisterForm">สมัครสมาชิก</a></div>
                                    <div class="user_icon"><img style="width: 20px; height: 20px; filter: opacity(0.5);"
                                            src="../layout/images/sign-in-alt-solid.svg" alt=""></div>
            ...
            <div class="header_main">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="header_search">
                                <div class="header_search_content">
                                    <div class="header_search_form_container">
                                        <input id="searchIndex" list="product" type="search" required="required"
                                            class="header_search_input" placeholder="ค้นหาสินค้า , ร้านค้า ..."
                                            onkeyup="search()" autocomplete="off">
                                        <datalist id="product">
                                        </datalist>

                                        <button onclick="submitSearch()" type="button"
                                            class="header_search_button trans_300" value="Submit"><img
                                                src="../layout/images/search.png" alt=""></button>
                        ...
                        <!-- Wishlist -->
                        <div class="col-lg-4 col-md-6 col-9 order-lg-3 order-2 text-lg-right text-right">
                                        ...
                                        <ul class="dropdown-menu dropdown-alerts">
                                            ...
                                            <li>
                                                <a onclick="compare()">
                                                    <div>
                                                        <button type="button"
                                                            class="btn btn-w-m btn-info">เปรียบเทียบสินค้า</button>
                                                    </div>
                                                </a>
                                            </li>
                                        </ul>
                                        <div class="cart_icon" id="icon_compare">
                                            <img style="width:32px;height:32px;" src="../layout/images/arrow.png"
                                                alt="">
                            ...
                            <div class="main_nav_content d-flex flex-row">
                                    ...
                                    <ul class="cat_menu">
                                        <li class="hassubs">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#">เตียง 3.5 ฟุต<i class="fas fa-chevron-right"></i></a>
                                                </li>
                                                <li><a href="#">เตียงผ้า<i class="fas fa-chevron-right"></i></a></li>
                                                <li><a href="#">กระจก<i class="fas fa-chevron-right"></i></a></li>
                                                <li><a href="#">โต๊ะเครื่องแป้ง<i class="fas fa-chevron-right"></i></a>
                                                </li>
                                                <li><a href="#">ตู้ข้างเตียง<i class="fas fa-chevron-right"></i></a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="hassubs">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#">ที่นอนพ็อคเกตสปริง<i
                                                            class="fas fa-chevron-right"></i></a></li>
                                                <li><a href="#">ที่นอนยางพารา<i class="fas fa-chevron-right"></i></a>
                                                </li>
                                                <li><a href="#">ที่นอนเมมโมรี่โฟม<i
                                                            class="fas fa-chevron-right"></i></a></li>
                                                ...
                                                <li><a href="#">แผ่นรองที่นอน<i class="fas fa-chevron-right"></i></a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="hassubs">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#">ชุดตู้หนังสือ<i class="fas fa-chevron-right"></i></a>
                                                </li>
                                                <li><a href="#">กล่องเก็บของ<i class="fas fa-chevron-right"></i></a>
                                                </li>
                                        ...
                                        <li class="hassubs">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#">ชุดโต๊ะอาหาร<i class="fas fa-chevron-right"></i></a>
                                                </li>
                                                <li><a href="#">เคาน์เตอร์บาร์<i class="fas fa-chevron-right"></i></a>
                                                </li>
                                                <li><a href="#">ของใช้ในครัวและโต๊ะอาหาร<i
                                                            class="fas fa-chevron-right"></i></a></li>
                                            </ul>
                                        </li>
                                        <li class="hassubs">
                                ...
                                <div class="main_nav_menu ml-auto">
                                    <ul class="standard_dropdown main_nav_dropdown">
                                        <li><a href="/promotion">โปรโมชัน<i class="fas fa-chevron-down"></i></a></li>
                                        <li><a href="/content">บทความ<i class="fas fa-chevron-down"></i></a></li>
                                    </ul>
                                </div>
                        ...
                        <div class="col">
                            ...
                            <div class="page_menu_content">
                                ...
                                <div class="page_menu_search">
                                    <input class="page_menu_search_input" id="searchIndex" list="product" type="search"
                                        required="required" placeholder="ค้นหาสินค้า , ร้านค้า ..." onkeyup="search()"
                                        autocomplete="off">
                                    <datalist id="product">
                                    </datalist>
                                    <button onclick="submitSearch()" type="button"
                                        class="header_search_button-xs trans_300" value="Submit"><img
                                            src="../layout/images/search.png" alt=""></button>
                                ...
                                <ul class="page_menu_nav">
                                    ...
                                    <li class="page_menu_item">
                                        <a href="/promotion">โปรโมชัน<i class="fa fa-angle-down"></i></a>
                                    </li>
                                    <li class="page_menu_item"><a href="/content">บทความ<i
                                ...
                                <div class="menu_contact">
                                    ...
                                    <div class="menu_contact_item">
                                        <div class="menu_contact_icon"><img
                                                style="width: 20px; height: 20px; filter: opacity(0.5);"
                                                src="../layout/images/user-solid.svg" alt=""></div>
                                        <a data-toggle="modal" data-target="#modalRegisterForm">สมัครสมาชิก</a>
                                    </div>
                                    <div class="menu_contact_item">
                                        <div class="menu_contact_icon"><img
                                                style="width: 20px; height: 20px; filter: opacity(0.5);"
                                                src="../layout/images/sign-in-alt-solid.svg" alt=""></div>
                                        <a data-toggle="modal" data-target="#modalLoginForm">ลงชื่อเข้าใช้</a>
                                    </div>
                                    <div class="menu_contact_item ">
                                        <div class="menu_contact_icon"><img
                                                style="width: 20px; height: 20px; filter: opacity(0.5);"
                                                src="../layout/images/store-solid.svg" alt=""></div>
                                        <a href="/login">ขายสินค้า</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body mx-3">
                    ...
                    <div class="md-form mb-4">
                        ...
                        <input type="password" placeholder="รหัสผ่าน" id="password" required
                            class="form-control validate">
                    </div>

                </div>
                <div class="modal-footer d-flex justify-content-center">
                    <button id="login" class="btn btn-primary input-lg col-lg-8 btn-lg "
            ...
            <div class="modal-content">
                ...
                <div class="modal-body mx-3">
                    ...
                    <div class="md-form mb-3">
                        ...
                        <input type="text" name="regis_name" id="regis_name" class="form-control validate"
                    ...
                    <div class="md-form mb-3">
                        ...
                        <input type="date" name="birthday" id="birthday" class="form-control validate"
                    ...
                    <div class="md-form mb-3">
                        <i class="fas fa-lock prefix or"></i>
                        <input type="password" id="regis_password" name="regis_password" class="form-control validate"
                            placeholder="รหัสผ่าน" required>
                    </div>

                    <div class="md-form mb-3">
                        <i class="fas fa-unlock prefix or"></i>
                        <input type="password" id="c_password" name="c_password" class="form-control validate"
                            placeholder="ยืนยันรหัสผ่าน" required>
                    </div>

                    <div class="form-group-mg ch mb-3">
                        <label> <input id="role" required="" value="true" type="checkbox"
                                class="checkbox i-checks"><i></i> ยอมรับเงื่อนไขข้อตกลงจากผู้ให้บริการ </label>
                    </div>
                </div>
                <div class="modal-footer d-flex justify-content-center">
...
<script>
    ...
    function check_user() {
        ...
        if (b_token != null && buyer_id != null) {
            $("#top_bar_user").empty();
            $("#top_bar_user").html(
                '<div class="user_icon"><img src="../layout/images/user.svg" alt=""></div><div><div class="btn-group">' +
                '<a data-toggle="dropdown" class="btn-xs dropdown-toggle" aria-expanded="false">' + localStorage
                .getItem("name") + '<span class="caret"></span></a>' +
    ...
    $('#reg').click(function () {
        ...
        console.log(data);
        if ($("#regis_name").val() != '' && $("#surname").val() != '' && $("#birthday").val() != '' && $(
                "#regis_email").val() != '') {
                ...
                success: function (data) {
                    if (data['product'] != null) {
                        ...
                        for (var i = 0; i < data['product'].length; i++) {
                            $('#product').append('<option value="' + data['product'][i]['prod_name'] +
                                '"></option>');
                        }
