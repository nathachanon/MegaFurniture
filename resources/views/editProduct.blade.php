...
<script>
          ...
          $.ajax({
              ...
              success: function (data) {
                  ...
                  if (data['product_pic'][0]['pic_url1'] != null) {
                      ...
                      $('#spic1').removeAttr('hidden');
                      $("#spic1").attr("src", data['product_pic'][0]['pic_url1']);
                  }
                  if (data['product_pic'][0]['pic_url2'] != null) {
                      $('#i2').remove(".fa");
                      $('#is2').removeClass("i-size");
                      $('#spic2').removeAttr('hidden');
                      $("#spic2").attr("src", data['product_pic'][0]['pic_url2']);
                  }
                  if (data['product_pic'][0]['pic_url3'] != null) {
                      $('#i3').remove(".fa");
                      $('#is3').removeClass("i-size");
                      $('#spic3').removeAttr('hidden');
                      $("#spic3").attr("src", data['product_pic'][0]['pic_url3']);
                  }
                  if (data['product_pic'][0]['pic_url4'] != null) {
                      $('#i4').remove(".fa");
                      $('#is4').removeClass("i-size");
                      $('#spic4').removeAttr('hidden');
                      $("#spic4").attr("src", data['product_pic'][0]['pic_url4']);
                  }
                  if (data['product_pic'][0]['pic_url5'] != null) {
                      $('#i5').remove(".fa");
                      $('#is5').removeClass("i-size");
                      $('#spic5').removeAttr('hidden');
                      $("#spic5").attr("src", data['product_pic'][0]['pic_url5']);
                  }
                  //ke
  ...
  function roomselect() {
      ...
      if (catroom_id != 0) {
          document.cookie = 'CatRoom_id = ' + catroom_id;
          $("#CatProduct").empty();
          $("#inputs_wlhf").empty();
          $("#inputs_cr").empty();
