				...
				success: function(data){
							 ...
							 if(0 < rating_point && rating_point <= 0.5)
	             {
	               ...
	               '<span class="fa  fa-grey fa-star "></span>';
						 ...
						 $('#Rating_AVG').append('<h4 class="viewed_title">'+(data['data']['RatingAVG'][0]['RatingAVG'] != 'null' ? data['data']['RatingAVG'][0]['RatingAVG']:0)+'  เต็ม  5</h4>'+
				...
				success: function(data){
							 ...
							 if(0 < rating_point && rating_point <= 0.5)
	             {
	               ...
	               '<span class="fa  fa-grey fa-star "></span>';
						 ...
						 $('#Rating_AVG').append('<h4 class="viewed_title">'+data['data']['RatingAVG'][0]['RatingAVG']+'  เต็ม  5</h4>'+
 						'<fieldset class="rating ct">'+
						rating+
 						'</fieldset>');
					}
